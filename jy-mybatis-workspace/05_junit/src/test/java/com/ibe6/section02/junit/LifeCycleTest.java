...
/*
    ...
    2. 독립된 단위 테스트를 지원함
       > 단위 테스트
         ...
         : 연관된 컴포넌트가 개발되지 않더라도 기능별로 테스트 해볼 수 있음
    3. assert(단정문)메소드로 테스트 케이스의 수행 결과를 판별할 수 있음
...
public class LifeCycleTest {
    ...
    public void beforeEach(){
        System.out.println("@BeforEach-  각 테스트 메소드 전에 매번 실행됨 ====");
    }
    ...
    /* @AfterAll : 각 테스트 메소드 실행 후에 최종 1번만 실행됨 ==== */
    @AfterAll
